...
-----END RSA PRIVATE KEY-----
```
![task2a](https://github.com/Asad-Ali-Code/Public-Key-Infrastructure/blob/main/task2a.PNG)
![task2b](https://github.com/Asad-Ali-Code/Public-Key-Infrastructure/blob/main/task2b.PNG)
![task2c](https://github.com/Asad-Ali-Code/Public-Key-Infrastructure/blob/main/task2c.PNG)
...
![task2d](https://github.com/Asad-Ali-Code/Public-Key-Infrastructure/blob/main/task2d.PNG)
...
Certificate Details:
        ...
        Subject:
            ...
            emailAddress              = www.asadali.worked.area@gmail.com
        X509v3 extensions:
...
Data Base Updated
```
![task2e](https://github.com/Asad-Ali-Code/Public-Key-Infrastructure/blob/main/task2e.PNG)
![task2f](https://github.com/Asad-Ali-Code/Public-Key-Infrastructure/blob/main/task2f.PNG)
# Task 3
...
```
![task3](https://github.com/Asad-Ali-Code/Public-Key-Infrastructure/blob/main/task3.PNG)
...
```
![task3b](https://github.com/Asad-Ali-Code/Public-Key-Infrastructure/blob/main/task3b.PNG)
...
![task3d](https://github.com/Asad-Ali-Code/Public-Key-Infrastructure/blob/main/task3d.PNG)
### Step 4. Testing our HTTPS website
##### Modify one byte in ```server.pem```
![task3e](https://github.com/Asad-Ali-Code/Public-Key-Infrastructure/blob/main/task3e.PNG)
![task3f](https://github.com/Asad-Ali-Code/Public-Key-Infrastructure/blob/main/task3f.PNG)
...
![task3g](https://github.com/Asad-Ali-Code/Public-Key-Infrastructure/blob/main/task3g.PNG)
